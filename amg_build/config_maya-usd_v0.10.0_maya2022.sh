...
cur_dir=`pwd`
tmp_dir="tmp_mayausd_v${MAYAUSD_VER}_${MAYA_VER}_${MAYA_PYTHON_VERSION}"
...
deploy_dir="${deploy_root}/USD/autodesk/mayausd_v${MAYAUSD_VER}_${MAYA_VER}_${MAYA_PYTHON_VERSION}"
